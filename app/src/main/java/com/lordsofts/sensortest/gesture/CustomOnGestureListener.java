package com.lordsofts.sensortest.gesture;
...
import com.lordsofts.sensortest.GlobalValues;
...
public class CustomOnGestureListener implements OnGestureListener,
	...
	public void onSwipeLeft() {
		...
		showToast("left");
        gestureAction = GlobalValues.GESTURE_LEFT;
	...
	private void showToast(String action){
		Toast.makeText(mGestureName.getContext(), action, Toast.LENGTH_SHORT).show();
	}
